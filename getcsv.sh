...
if ! [ -f ./CSV/events.csv ] ; then
    echo "match_id;innings;ball;batsman;non_striker;batting_team;bowler;bowling_team;batsman_runs;extra_runs;total_runs;extra_type;out_type;player_out;fielder_involved" > ./CSV/events.csv
fi
